...
urlpatterns = [
    ...
    path(
        "meetingagefilter/", MeetingAgeGroupList.as_view(), name="MeetingAgeGroupList"
    ),
    path(
        "meetinggenderfilter/",
        MeetingGenderGroupList.as_view(),
        name="MeetingGenderGroupList",
    ),
    path(
        "meetingpaymentfilter/",
        MeetingPaymentMethodList.as_view(),
        name="MeetingPaymentMethodList",
    ),
